<template>
  <div class="vdatetime-popup">
    ...
    <div class="vdatetime-popup__body">
      <datetime-year-picker v-if="step === 'year'" @change="onChangeYear" :min-date="minDatetime"
        :max-date="maxDatetime" :year="year"></datetime-year-picker>
      <datetime-month-picker v-if="step === 'month'" @change="onChangeMonth" :min-date="minDatetime"
        :max-date="maxDatetime" :year="year" :month="month"></datetime-month-picker>
      <datetime-calendar v-if="step === 'date'" @change="onChangeDate" :year="year" :month="month" :day="day"
        :min-date="minDatetime" :max-date="maxDatetime" :week-start="weekStart"></datetime-calendar>
      <datetime-time-picker v-if="step === 'time'" @change="onChangeTime" :hour="hour" :minute="minute"
        :use12-hour="use12Hour" :hour-step="hourStep" :minute-step="minuteStep" :min-time="minTime" :max-time="maxTime">
